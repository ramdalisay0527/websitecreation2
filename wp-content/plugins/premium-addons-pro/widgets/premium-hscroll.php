...
//        );
        ...
        $this->add_control('doc_1',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s Check the video tutorial » %2$s', 'premium-addons-pro' ), '<a href="https://www.youtube.com/watch?v=4HqT_3s-ZXg" target="_blank" rel="noopener">', '</a>' ),
        ...
        $this->add_control('doc_2',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s Check the documentation article » %2$s', 'premium-addons-pro' ), '<a href="https://premiumaddons.com/docs/horizontal-scroll-widget-tutorial/?utm_source=papro-dashboard&utm_medium=papro-editor&utm_campaign=papro-plugin" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
        ...
        $this->add_control('doc_3',
            [
                'type'            => Controls_Manager::RAW_HTML,
                'raw'             => sprintf( __( '%1$s How to Play/Pause a Soundtrack Using Premium Button Widget » %2$s', 'premium-addons-pro' ), '<a href="https://premiumaddons.com/docs/how-to-play-pause-a-soundtrack-using-premium-button-widget/?utm_source=papro-dashboard&utm_medium=papro-editor&utm_campaign=papro-plugin" target="_blank" rel="noopener">', '</a>' ),
                'content_classes' => 'editor-pa-doc',
            ]
        );
    ...
    protected function render() {
        ...
        $hscroll_settings = [
            ...
            'leftArrow'     => esc_html( $settings['nav_arrow_left']['value'] ),
            'rightArrow'    => esc_html( $settings['nav_arrow_right']['value'] ),
        ];
