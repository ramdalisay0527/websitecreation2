    ...
    public function register_controls( $element ) {
        ...
        $element->add_control('premium_particles_custom_style',
            [
                ...
                'description'   => __( 'Particles has been updated with many new features. You can now generate the JSON config from <a href="https://particles.matteobruni.it/" target="_blank">here</a> or <a href="http://vincentgarreau.com/particles.js/#default" target="_blank">here</a>', 'premium-addons-pro' ),
                'render_type' => 'template',
            ]
        );
